...
@Composable
internal fun UserProfileErrorState(
...
@GhePreview
@Composable
private fun UserProfileErrorStateGenericPreview() {
    GitHubExplorerPreviewContainer {
        UserProfileErrorState(isRateLimited = false, onRetry = {})
    }
}

@GhePreview
@Composable
private fun UserProfileErrorStateRateLimitedPreview() {
    GitHubExplorerPreviewContainer {
        UserProfileErrorState(isRateLimited = true, onRetry = {})
    }
}
