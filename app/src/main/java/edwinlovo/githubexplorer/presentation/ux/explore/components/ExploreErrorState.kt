...
@Composable
internal fun ExploreErrorState(
...
@GhePreview
@Composable
private fun ExploreErrorStateGenericPreview() {
    GitHubExplorerPreviewContainer {
        ExploreErrorState(isRateLimited = false, onRetry = {})
    }
}

@GhePreview
@Composable
private fun ExploreErrorStateRateLimitedPreview() {
    GitHubExplorerPreviewContainer {
        ExploreErrorState(isRateLimited = true, onRetry = {})
    }
}
