...
@Composable
internal fun LanguagePickerTopBar(
    onBackClicked: () -> Unit,
    ...
    Row(
        ...
        IconButton(onClick = onBackClicked) {
            Icon(
                ...
                contentDescription = stringResource(R.string.languagepicker_back),
                tint = GheTheme.colors.iconDefault,
                modifier = Modifier.size(GheTheme.iconSize.md),
            )
        }
        Text(
            text = stringResource(R.string.languagepicker_title),
...
@GhePreview
@Composable
private fun LanguagePickerTopBarPreview() {
    GitHubExplorerPreviewContainer {
        LanguagePickerTopBar(onBackClicked = {})
    }
}
