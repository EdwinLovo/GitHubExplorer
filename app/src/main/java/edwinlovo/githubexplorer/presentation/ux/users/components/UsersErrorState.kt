...
@GhePreview
@Composable
private fun UsersErrorStateGenericPreview() {
    GitHubExplorerPreviewContainer {
        UsersErrorState(isRateLimited = false, onRetry = {})
    }
}

@GhePreview
@Composable
private fun UsersErrorStateRateLimitedPreview() {
    GitHubExplorerPreviewContainer {
        UsersErrorState(isRateLimited = true, onRetry = {})
    }
}
