...
private fun ExploreSearchBarEmptyPreview() {
    GitHubExplorerPreviewContainer {
        ExploreSearchBar(query = EMPTY_STRING, onQueryChanged = {}, onClearQuery = {})
    }
}

@GhePreview
@Composable
private fun ExploreSearchBarWithQueryPreview() {
    GitHubExplorerPreviewContainer {
        ExploreSearchBar(query = "compose", onQueryChanged = {}, onClearQuery = {})
    }
}
