...
- `NavigationRoute`, `ViewModelNav`, `NavigationAction`, or `HandleNavigation` referenced but the files don't exist in `edwinlovo.githubexplorer/presentation/ui/navigation/` → invoke the `navigation-primitives` skill
