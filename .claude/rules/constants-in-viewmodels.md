...
| Used across data + presentation | `edwinlovo.githubexplorer/utils/Constants.kt` (top-level) |
| Design token (spacing, corner radius, color) | `GheTheme` — see `rules/theming-and-tokens.md` |
