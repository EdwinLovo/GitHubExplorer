...
Using the templates from `.claude/skills/data-feature/SKILL.md`, create the files in this order. Each template block in the skill is one section (§1–§8) — read the section, then apply it verbatim substituting `<Resource>`, `<feature>`, `edwinlovo.githubexplorer`, and the user's answers.
