...
> Primary examples use **Retrofit (Apollo/GraphQL)**. For a Retrofit codebase, the "Retrofit variant" section at the bottom shows the equivalent shape — the layering is identical.
...
package edwinlovo.githubexplorer.domain.model.response.auth
...
```kotlin
package edwinlovo.githubexplorer.data.repository.auth
...
package edwinlovo.githubexplorer.data.mappers.auth
...
```kotlin
package edwinlovo.githubexplorer.data.repository.<feature>
