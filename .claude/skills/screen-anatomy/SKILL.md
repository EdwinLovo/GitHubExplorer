...
| `edwinlovo.githubexplorer` | Kotlin package root | `com.example.myapp` |
...
```kotlin
package edwinlovo.githubexplorer.presentation.ux.<feature>.contracts
...
import edwinlovo.githubexplorer.presentation.ux.<feature>.contracts.<Screen>Event
import edwinlovo.githubexplorer.presentation.ux.<feature>.contracts.<Screen>UiState
...
```kotlin
package edwinlovo.githubexplorer.presentation.ux.<feature>.delegates

import edwinlovo.githubexplorer.presentation.ux.<feature>.contracts.<Child>Event
import edwinlovo.githubexplorer.presentation.ux.<feature>.contracts.<Child>UiState
import edwinlovo.githubexplorer.presentation.utils.ext.reduce
...
**Add 2 imports** — alphabetically among existing `edwinlovo.githubexplorer.presentation.ux.*` imports:
```kotlin
import edwinlovo.githubexplorer.presentation.ux.<feature>.<Screen>Route
import edwinlovo.githubexplorer.presentation.ux.<feature>.<Screen>Screen
```
