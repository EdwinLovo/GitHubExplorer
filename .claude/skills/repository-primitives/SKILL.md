...
Path: `edwinlovo.githubexplorer/domain/utils/ApiResult.kt`
...
Path: `edwinlovo.githubexplorer/data/remote/HttpConstants.kt`

```kotlin
package edwinlovo.githubexplorer.data.remote
...
Path: `edwinlovo.githubexplorer/data/repository/BaseRepository.kt`

```kotlin
package edwinlovo.githubexplorer.data.repository

import edwinlovo.githubexplorer.data.remote.GRAPHQL_ERROR_CODE_INTERNAL_SERVER_ERROR
import edwinlovo.githubexplorer.data.remote.GRAPHQL_ERROR_CODE_KEY
import edwinlovo.githubexplorer.data.remote.GRAPHQL_ERROR_CODE_UNAUTHENTICATED
...
Path: `edwinlovo.githubexplorer/data/paging/BasePagingSource.kt`
